...
var socket = io();
socket.on("play", () => this.player.play());
socket.on("pause", () => this.player.pause());
socket.on("seek", (time) => this.player.setCurrentTime(time));
socket.on("setVideo", (platform, videoId) => this.player.playback(platform, videoId));

socket.on("userupdate"), (data) => updateUserlist(data);
